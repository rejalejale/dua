...
Route::group(['middleware' => ['isAdmin','auth'],'prefix' => 'admin', 'as' => 'admin.'], function() {
    ...
    Route::resource('riwayats', \App\Http\Controllers\Admin\BookingController::class);
    ...
    Route::delete('hancurkan', [\App\Http\Controllers\Admin\BookingController::class, 'hancurkan'])->name('hancurkan.sayang');
    Route::delete('leburkan', [\App\Http\Controllers\Admin\BookingController::class, 'leburkan'])->name('hancurkan.baby');
