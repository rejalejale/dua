...
class CountryController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(jadwal $country)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, jadwal $country)
    {
    ...
    public function show(jadwal $country)
    {
        $driver = supir::where('nama',$country->nama)->get();
        $driver = $driver[0];


        return view('admin.bookings.show', compact('country','driver'));;
    }
}
